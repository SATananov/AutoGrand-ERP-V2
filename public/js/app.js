document.addEventListener('DOMContentLoaded', () => {
  ...
  const tabButtons = Array.from(document.querySelectorAll('[data-card-tab]'));
  const tabPanels = Array.from(document.querySelectorAll('[data-card-panel]'));
