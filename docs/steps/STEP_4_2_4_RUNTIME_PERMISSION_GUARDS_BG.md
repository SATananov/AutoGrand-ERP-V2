# Step 4.2.4 — Runtime Permission Guards / Menu, Route & Action Guard
...
Step 4.2.4 използва този контекст, за да пази менюта, директни URL-и и действия върху документи.
...
Затова Step 4.2.4 добавя централен permission слой, който може да се развива към по-фина матрица без промяна на текущата Prisma схема.
...
Step 4.2.4 не променя базата. Той използва вече наличния Login Context и permissions от Step 4.2 / 4.3.

## Health label

```text
4-2-4-runtime-permission-guards-menu-route-action-guard
```
